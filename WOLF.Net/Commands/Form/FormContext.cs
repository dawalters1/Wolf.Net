...
namespace WOLF.Net.Commands.Form
{
    public abstract class FormContext : IFormContext
    {
        ...
        public async Task<Response<MessageResponse>> SendMessageAsync(object content, bool includeEmbeds = false) => await Bot.Messaging().SendMessageAsync(Command.SourceTargetId, content, Command.MessageType, includeEmbeds);
