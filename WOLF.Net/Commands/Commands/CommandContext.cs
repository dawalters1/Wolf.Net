...
namespace WOLF.Net.Commands.Commands
{
    public abstract class CommandContext
    {
		...
		public async Task<Response<MessageResponse>> SendMessageAsync(object content, bool includeEmbeds = false) => await Bot.Messaging().SendMessageAsync(Command.TargetGroupId, content, Command.MessageType, includeEmbeds);
